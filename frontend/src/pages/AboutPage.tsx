          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal direction="right">
              <div className="relative flex flex-col items-center lg:items-start">
                <div className="relative w-72 h-80 rounded-3xl overflow-hidden shadow-glow-lg">
                  <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-dental-teal/30 to-dental-blue/20 scale-110" />
                  <img
                    src="/assets/generated/doctor-neha-verma.dim_600x700.jpg"
                    alt="Dr. Neha Verma, BDS MDS"
                    className="relative w-full h-full object-cover object-top border-4 border-dental-teal rounded-3xl"
                  />
                </div>
