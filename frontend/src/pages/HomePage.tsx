...
const TESTIMONIALS = [
  {
    ...
    img: "/assets/generated/testimonial-patient-1.dim_200x200.jpg",
  },
  {
    name: "Vikram Nair",
    city: "Bhopal",
    text: "The implant looks and feels exactly like my natural tooth. Remarkable work and absolutely painless process.",
    img: "/assets/generated/testimonial-patient-2.dim_200x200.jpg",
  },
];
            ...
            >
              ...
              <div className="glass rounded-2xl px-5 py-4 flex items-center gap-4">
                <div className="flex -space-x-2">
                  {[
                    "/assets/generated/testimonial-patient-1.dim_200x200.jpg",
                    "/assets/generated/testimonial-patient-2.dim_200x200.jpg",
                    "/assets/generated/testimonial-patient-3.dim_200x200.jpg",
                  ].map((s) => (
                    <img
                      key={s}
                      src={s}
