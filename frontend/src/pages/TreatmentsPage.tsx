...
const TREATMENTS = [
  {
    ...
    img: "/assets/generated/treatment-teeth-whitening.dim_600x400.jpg",
  ...
  },
  {
    ...
    img: "/assets/generated/treatment-dental-implants.dim_600x400.jpg",
  ...
  },
  {
    ...
    img: "/assets/generated/treatment-root-canal.dim_600x400.jpg",
  ...
  },
  {
    ...
    img: "/assets/generated/treatment-braces-orthodontics.dim_600x400.jpg",
  ...
  },
  {
    ...
    img: "/assets/generated/treatment-smile-makeover.dim_600x400.jpg",
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {TREATMENTS.map((t, i) => (
              <ScrollReveal key={t.title} delay={i * 0.08}>
                ...
                >
                  {/* Treatment image at top */}
                  <div className="rounded-t-3xl overflow-hidden h-44 flex-shrink-0">
                    <img
                      src={t.img}
                      alt={t.title}
                  ...
                  <div className="p-8 flex flex-col flex-1 relative">
                    ...
                    <p className="tc-desc font-body text-[14px] text-dental-blue/60 leading-relaxed transition-colors duration-300 flex-1">
                      {t.desc}
                    </p>
